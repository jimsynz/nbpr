defmodule Nbpr.DockerCliBuildx.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      package: [
        organization: "nbpr",
        licenses: ["Apache-2.0"],
        links: %{"GitHub" => "https://github.com/jimsynz/nbpr", "docker-cli-buildx" => "https://github.com/docker/buildx"}
      ]
    ]
  end
