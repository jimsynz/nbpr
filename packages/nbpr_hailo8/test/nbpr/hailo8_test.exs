defmodule NBPR.Hailo8Test do
  use ExUnit.Case, async: true

  test "package metadata is well-formed" do
    pkg = NBPR.Hailo8.__nbpr_package__()

    assert pkg.module == NBPR.Hailo8
    assert pkg.name == :hailo8
  ...
  test "generates an Application that declares the hailo_pci module" do
    assert NBPR.Hailo8.Application.kernel_modules() == ["hailo_pci"]
  end
